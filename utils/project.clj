(defproject systems.casemgr.utils/utils "0.1.0-SNAPSHOT"
  ...
  :main systems.casemgr.utils.utils.server
  ...
  :cljsbuild {:builds
              [{:id           "app"
                ...
                ;; :figwheel {:on-jsload "systems.casemgr.utils.utils.core/on-figwheel-reload"}

                :compiler     {:main                 systems.casemgr.utils.utils.core
                               :asset-path           "js/compiled/out"
                               :output-to            "resources/public/js/compiled/systems/casemgr/utils/utils.js"
               ...
               {:id           "test"
                ...
                :compiler     {:output-to     "resources/public/js/compiled/testable.js"
                               :main          systems.casemgr.utils.utils.test-runner
                               :optimizations :none}}
